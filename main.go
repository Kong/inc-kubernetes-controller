...
func main() {
	...
	flag.StringVar(&metricsAddr, "metrics-bind-address", ":10255", "The address the metric endpoint binds to.")
	flag.StringVar(&probeAddr, "health-probe-bind-address", ":10254", "The address the probe endpoint binds to.")
